...
$(document).ready(function(){
	...
	for(i=0 ; i<arrayAttendingEvents.length ; i++){
		...
		$('#event-scroll').append('<div id="'+arrayAttendingEvents[i].eventName+'" class="event-card"><div class="card-left"><h1><div class="hour">'+ arrayAttendingEvents[i].hour+'</div>:<div class="minute">'+arrayAttendingEvents[i].minute +'</div></h1><p class="building">'+ arrayAttendingEvents[i].place +'</p><p class="mapButton"><img src="images/map.png"></p></div><div class="card-right"><h2>'+ arrayAttendingEvents[i].eventName +'</h2><p>'+ arrayAttendingEvents[i].description +'</p><img class="arrow" src="images/downArrow.png"></div></div>');
